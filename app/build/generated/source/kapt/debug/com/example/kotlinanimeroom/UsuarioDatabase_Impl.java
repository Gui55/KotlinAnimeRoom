  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Usuario` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `userName` TEXT NOT NULL, `senha` TEXT NOT NULL, `imagem` BLOB NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"a026a127d325acd27b8f3519bfb48725\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsUsuario.put("userName", new TableInfo.Column("userName", "TEXT", true, 0));
        _columnsUsuario.put("senha", new TableInfo.Column("senha", "TEXT", true, 0));
        _columnsUsuario.put("imagem", new TableInfo.Column("imagem", "BLOB", true, 0));
        ...
        if (! _infoUsuario.equals(_existingUsuario)) {
          throw new IllegalStateException("Migration didn't properly handle Usuario(com.example.kotlinanimeroom.Usuario).\n"
                  + " Expected:\n" + _infoUsuario + "\n"
                  + " Found:\n" + _existingUsuario);
        }
      }
    }, "a026a127d325acd27b8f3519bfb48725", "f7116afeb3afbe0261488b4ca3c0f763");
